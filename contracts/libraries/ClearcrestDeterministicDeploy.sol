...
library ClearcrestDeterministicDeploy {
    ...
    bytes32 internal constant CCR_TOKEN_SALT = keccak256("clearcrest.ccr.token.v1.2026-05-24");
    bytes32 internal constant CGOV_TOKEN_SALT = keccak256("clearcrest.cgov.token.v1.2026-05-24");
