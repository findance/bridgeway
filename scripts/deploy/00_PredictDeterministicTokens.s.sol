...
contract PredictDeterministicTokens is Script {
    function run() external view {
        ...
        console.log("CCR_TOKEN_PREDICTED=", predictedCCR);
        console.log("CCR_TOKEN_CODE_LENGTH=", predictedCCR.code.length);
        console.log("CGOV_TOKEN_PREDICTED=", predictedCGOV);
        console.log("CGOV_TOKEN_CODE_LENGTH=", predictedCGOV.code.length);
